...
The code for webscraping and data cleaning can be found in the file: <a href = "https://github.com/scullem/quantitative_casting/blob/master/02_luther_data_collection_scullem_v2.ipynb"/a> 02_luther_data_collection_scullem_v2.ipynb 
